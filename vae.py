...
class VAE(nn.Module):
    def __init__(self, input_size, latent_size=15):
        ...
        self.decoder = None
        self.H = int(np.sqrt(self.input_size))
        ############################################################################################
        ...
        self.decoder = nn.Sequential(
            ...
            nn.Sigmoid(),
            nn.Unflatten(1,(1,self.H,self.H))
            )
        ############################################################################################
        #                                      END OF YOUR CODE                                    #
        ############################################################################################
...
def loss_function(x_hat, x, mu, logvar):
    ...
    ################################################################################################
    # Replace "pass" statement with your code
    loss1 = nn.functional.binary_cross_entropy(x_hat,x,reduction='sum')
    loss2 = -1/2 * torch.sum((1 + logvar-mu**2-torch.exp(logvar)))
    loss = loss1 + loss2
    loss = loss/mu.size(0)
    ################################################################################################
    #                            END OF YOUR CODE                                                  #
